...
// #define DeclareRegeneratingAttributeSet(Name)\
// DeclareGameplayTag_Regenerating(Name);\
// UCLASS()\
// class PWATTRIBUTES_API UAS_##Name## : public UPWAttributeSet_RegeneratingAttribute \
// { GENERATED_BODY() };
// #define DefineRegeneratingAttributeSet(Name)\
// DefineGameplayTags_Regenerating(Name);
//
// #define DeclareRegeneratingAttribute(Name)\
// UPROPERTY(VisibleAnywhere, BlueprintReadOnly) \
// TObjectPtr<class UPWAttributeSet_RegeneratingAttribute> Name;
// #define DefineRegeneratingAttribute(Name)\
// Name = CreateDefaultSubobject<UAS_##Name##>(#Name);
//
// //put in .h outside class
// #define DeclareAttributeGameplayTag_Regenerating(Name) \
...
// #define DefineAttributeGameplayTags_Regenerating(Name) \
// namespace PWTags::Attributes { \
