...
AActor* UPWAbilityMultiActorModule::SpawnActor(const FPWTargetingResult& Target)
{
    if (ActorCount <= 1)
    {
        return Super::SpawnActor(Target);
    }
...
void UPWAbilityMultiActorModule::SpawnMultipleActors(const FPWTargetingResult& Target)
{
    if (ActorCount <= 1)
    {
...
void UPWAbilityMultiActorModule::SpawnOneActorInSequence(const FPWTargetingResult& Target)
{
    ...
    Super::SpawnActor(ModifiedTarget);
    CurrentSpawnIndex++;
}

float UPWAbilityMultiActorModule::GetEffectiveRadius() const
{
    if (Radius > 0.f)
        return Radius;
        
    if (UPWAbilityRadiusModule* RadiusModule = OwnerAbility->GetRadiusModule())
    {
...
void UPWAbilityMultiActorModule::BuildSpawnPositions(const FVector& CenterLocation, float InRadius)
{
...
void UPWAbilityMultiActorModule::Build_CircleClockwise(const FVector& Center, float InRadius)
{
    if (InRadius <= 0.f)
    {
...
void UPWAbilityMultiActorModule::Build_CircleCounterClockwise(const FVector& Center, float InRadius)
{
    Build_CircleClockwise(Center, InRadius);
    Algo::Reverse(CachedSpawnPositions);
}

void UPWAbilityMultiActorModule::Build_SpreadOutFromCenter(const FVector& Center, float InRadius)
{
    if (InRadius <= 0.f)
    {
...
void UPWAbilityMultiActorModule::Build_SpreadIntoCenter(const FVector& Center, float InRadius)
{
    if (InRadius <= 0.f)
    {
        Build_GatherAtCenter(Center, InRadius);
...
void UPWAbilityMultiActorModule::Build_GatherAtCenter(const FVector& Center, float InRadius)
{
    for (int32 i = 0; i < ActorCount; ++i)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_GridPattern(const FVector& Center, float InRadius)
{
    if (InRadius <= 0.f)
    {
        Build_GatherAtCenter(Center, InRadius);
...
FVector UPWAbilityMultiActorModule::GetCastDirection(const FPWTargetingResult& Target) const
{
...
void UPWAbilityMultiActorModule::Build_LineHorizontal(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineVertical(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineHorizontalForward(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineHorizontalBackward(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineHorizontalSpreadOut(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineHorizontalSpreadIn(const FVector& Center, float InRadius)
{
    Build_LineHorizontalSpreadOut(Center, InRadius);
    Algo::Reverse(CachedSpawnPositions);
}

void UPWAbilityMultiActorModule::Build_LineVerticalForward(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineVerticalBackward(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineVerticalSpreadOut(const FVector& Center, float InRadius)
{
    if (ActorCount <= 1)
    {
        CachedSpawnPositions.Add(Center);
...
void UPWAbilityMultiActorModule::Build_LineVerticalSpreadIn(const FVector& Center, float InRadius)
{
    Build_LineVerticalSpreadOut(Center, InRadius);
    Algo::Reverse(CachedSpawnPositions);
}

void UPWAbilityMultiActorModule::Build_Random(const FVector& Center, float InRadius)
{
    if (InRadius <= 0.f)
    {
        Build_GatherAtCenter(Center, InRadius);
