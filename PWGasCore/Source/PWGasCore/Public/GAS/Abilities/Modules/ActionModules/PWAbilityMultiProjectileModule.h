...
#include "PWAbilityProjectileModule.h"
#include "PWAbilityMultiProjectileModule.generated.h"
 ...
 */
UCLASS()
class PWGASCORE_API UPWAbilityMultiProjectileModule : public UPWAbilityProjectileModule
{
	GENERATED_BODY()
...
public:
	...
	virtual AActor* SpawnProjectile(const FPWTargetingResult& Target) override;
